          ...
          <div className="bg-white">
            <div className="mx-auto max-w-7xl py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                  <h3 className="text-base font-medium text-gray-900">Tel.</h3>
                  <p className="mt-2 text-sm text-gray-500">
                ...
                {/* <div>
                  <h3 className="text-base font-medium text-gray-900">Map</h3>
                  <p className="mt-2 text-sm text-gray-500">
                    <span className="block" id='map' style={{width:"300px", height:"200px"}}>Map Update</span>
                  </p>
                </div> */}
              </div>
            </div>
